 ...
 */
public class HomeShopListAdapter  extends ArrayAdapter<Company> {

    public HomeShopListAdapter(Context context, List<Company> items) {
        super(context, R.layout.listview_company, items);
    }
